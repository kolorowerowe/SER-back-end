...
public class CompanyResponse {
    ...
    public CompanyResponse(Company company, User primaryUser, CompanyDeadlineStatusesDTO companyDeadlineStatuses){
        ...
        this.sponsorshipPackage = company.getSponsorshipPackage();
